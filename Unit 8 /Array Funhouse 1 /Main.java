...
public class Main
{
	public static void main( String args[] )
	{
		...
		System.out.println("total of spots 3-6  =  " + ArrayFunHouse.getTotal(one,3,6));
		System.out.println("total of spots 2-9  =  " + ArrayFunHouse.getTotal(one,2,9));
    ...
    System.out.println(Arrays.toString(two));//prints the array
		System.out.println("total of spots 20-21  =  " + ArrayFunHouse.getTotal(two,20,21));
		System.out.println("total of spots 8-11  =  " + ArrayFunHouse.getTotal(two,8,11));
